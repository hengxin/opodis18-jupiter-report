...
\begin{frame}{}
  ...
  \begin{center}
    {\large We show the \hl{pairwise state compatibility} property \blue{in three steps}.} \\[5pt] 
    \red{By Contradiction, By Induction, and By Case Analysis.}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.60\textwidth}
      \fig{width = 0.50\textwidth}{figs/lca}
...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.60\textwidth}
	\fig{width = 0.50\textwidth}{figs/disjoint-paths}
      \column{0.30\textwidth}
	\[
	  v_0 = \text{LCA}(v_1, v_2)
	\]
...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.60\textwidth}
	\fig{width = 0.55\textwidth}{figs/compatible-paths}
