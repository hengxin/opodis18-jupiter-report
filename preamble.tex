...
\usefonttheme[]{serif} % try "professionalfonts"; also try ``onlymath'' in []
...
\newcommand{\slspec}{$\mathcal{A}_{\text{strong}}$}
...
\addbibresource{opodis18-jupiter-report.bib}
...
\newcommand{\thankyou}{
  \begin{frame}{}
	...
	\fig{width = 0.80\textwidth}{figs/thankyou}
      \column{0.50\textwidth}
	\fig{width = 0.70\textwidth}{figs/qa-green}
    \end{columns}
  \end{frame}
}
